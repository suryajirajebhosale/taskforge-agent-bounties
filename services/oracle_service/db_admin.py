...
Usage: `uv run python -m services.oracle_service.db_admin create|drop`
"""
...
def _main() -> None:
    parser = argparse.ArgumentParser(description="Oracle verification service schema management.")
